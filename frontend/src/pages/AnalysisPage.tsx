          ...
          {analysisRows.length > 0 ? (
            <section className="summary-panel">
              <div className="summary-group summary-target">
                <h3>Target</h3>
                {targetRows.map((row) => (
                  <span key={`target-${row.category}`} className="summary-pill">
                ...
                {clusterTargetRows.length > 0 && (
                  <>
                    ...
                    {clusterTargetRows.map((row) => (
                      <span key={`ct-${String(row.category)}`} className="summary-cluster-pill">
                        {String(row.display).replace("/G", "")}
              ...
              <div className="summary-group summary-defend">
                <h3>Defend</h3>
                {defendRows.map((row) => (
                  <span key={`defend-${row.category}`} className="summary-pill">
                    {row.display.replace("/G", "")}
                    {row.z_gap_down !== null && (
                ...
                {clusterDefendRows.length > 0 && (
                  <>
                    ...
                    {clusterDefendRows.map((row) => (
                      <span key={`cd-${String(row.category)}`} className="summary-cluster-pill">
                        {String(row.display).replace("/G", "")}
